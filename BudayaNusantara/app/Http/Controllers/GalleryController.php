...
class GalleryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('galeri.index', compact('galleries', 'categories', 'regions'));
    }
    ...
    public function create()
    {
        ...
        return view('galeri.create', compact('categories', 'regions'));
    }
    ...
    public function edit(Gallery $gallery)
    {
        ...
        return view('galeri.edit', compact('gallery', 'categories', 'regions'));
    }
  ...
  public function update(Request $request, Gallery $gallery)
{
    ...
    return redirect()->route('galeri.show', $gallery)->with('success', 'Galeri berhasil diperbarui.');
}
