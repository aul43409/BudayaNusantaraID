    ...
    <div id="sidebar" class="fixed left-0 top-0 h-full w-64 light-gradient glass-effect z-50 transform sidebar-hidden lg:sidebar-visible transition-transform duration-300 ease-in-out">
        <div class="p-6">
            ...
            <nav class="space-y-2">
                ...
                <a href="{{ route('galeri.index') }}" class="nav-item flex items-center px-4 py-3 rounded-xl hover:bg-white/50 text-gray-700 hover:text-red-700 transition-all duration-200">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('galeri.create') }}" class="nav-item flex items-center px-4 py-3 rounded-xl hover:bg-white/50 text-gray-700 hover:text-red-700 transition-all duration-200">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="xl:col-span-2">
    <div class="glass-effect rounded-2xl p-8 border border-white/30">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <a href="{{ route('galeri.create') }}" class="group glass-effect rounded-xl p-6 hover-lift transition-all duration-300 border border-white/30">
                <div class="flex items-center mb-4">
            ...
            <a href="{{ route('galeri.index') }}" class="group glass-effect rounded-xl p-6 hover-lift transition-all duration-300 border border-white/30">
                <div class="flex items-center mb-4">
