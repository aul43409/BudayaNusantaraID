    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <form method="GET" action="{{ route('galeri.public') }}" class="row g-3">
                        <div class="col-md-6">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex flex-wrap gap-2 justify-content-center">
                ...
                <a href="{{ route('galeri.public', ['category' => 'pakaian_adat']) }}" 
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <a href="{{ route('galeri.public.show', $featuredGallery) }}" 
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6 text-end">
                @if(request('search') || request('category'))
                    <a href="{{ route('galeri.public') }}" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="card h-100 gallery-card border-0 shadow-sm">
                    <div class="position-relative overflow-hidden">
                        ...
                        <div class="card-img-overlay d-flex align-items-center justify-content-center gallery-overlay">
                            <a href="{{ route('galeri.public.show', $gallery) }}" 
                    ...
                    <div class="card border-0 bg-light">
                        <div class="card-body py-5">
                            ...
                            @if(request('search') || request('category'))
                                ...
                                <a href="{{ route('galeri.public') }}" class="btn btn-danger">
